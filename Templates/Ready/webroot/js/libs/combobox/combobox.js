...
!function( $ ) {
 ...
 "use strict"
  ...
  template: '<div class="combobox-container"><input type="text" class="input-medium" /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
